      ...
      schemas: {
        ...
        BudgetTemplate: {
          ...
          properties: {
            ...
            frequency: { type: 'string', enum: ['monthly', 'weekly'], example: 'monthly' },
        ...
        BudgetInstance: {
          ...
          properties: {
            ...
            period_start: { type: 'string', format: 'date', example: '2026-07-01' },
            period_end: { type: 'string', format: 'date', example: '2026-07-31' },
        ...
        BudgetSummary: {
          ...
          properties: {
            ...
            spent: { type: 'number', example: 450000 },
            remaining: { type: 'number', example: 550000 },
            days_left: { type: 'integer', example: 12 },
            daily_estimate: { type: 'number', example: 45833 },
          },
        },
      },
    },
